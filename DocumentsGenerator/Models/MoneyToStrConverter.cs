  ...
  ""CurrencyList"" : {
    ...
    ""PER10000"" : [
      ...
      },
      {
        ...
        public MoneyToStrConverter(string currency, string language, string pennies)
        {
            if (currency == null)
            {
        ...
        public static string percentToStr(double amount, string lang)
        {
            ...
            {
                result = new MoneyToStrConverter("PER10", lang, "TEXT").convert(intPart, fractPart);
            }
            ...
            else if (Math.Round(amount * NUM100, 4) == (long)(amount * NUM100))
            {
                ...
                result = new MoneyToStrConverter("PER100", lang, "TEXT").convert(intPart, fractPart);
            }
            else if (Math.Round(amount * NUM1000, 4) == (long)(amount * NUM1000))
            {
                fractPart = (long)Math.Round((amount - intPart) * NUM1000);
                result = new MoneyToStrConverter("PER1000", lang, "TEXT").convert(intPart, fractPart);
            }
            else
            {
                fractPart = (long)Math.Round((amount - intPart) * NUM10000);
                result = new MoneyToStrConverter("PER10000", lang, "TEXT").convert(intPart, fractPart);
            }
            return result;
        }
